#!/usr/bin/env python
# coding: utf-8
# Copyright (c) 2013-2014 Abram Hindle and ZiQing Ma
...
# ZiQing Ma - https://github.com/zma9216/CMPUT404-assignment-ajax/blob/master/server.py
# Same implementation as Assignment #4
@app.route('/')
def hello():
